...
export function TokenSection() {
  return (
    <Section gap={8} id="tokens">
      ...
      <Wrapper size="xs">
        <Text as="p" muted>
          Most theming happens at the system level — partial JSON files that remap
          token references, with the CSS cascade doing the rest. When you need
          finer control, component-level overrides are there too — like giving
          input fields a white surface instead of inheriting surface-default. A
          theme that overrides nothing is identical to base.
        </Text>
      </Wrapper>
    </Section>
  );
