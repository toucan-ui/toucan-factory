  ...
  return (
    <>
      ...
      <NavBar
        ...
        actions={
          <Flex row gap={6} align="center">
            <Link href="#benefits" variant="standalone">Benefits</Link>
            <Link href="#science" variant="standalone">Science</Link>
            <Link href="#reviews" variant="standalone">Reviews</Link>
            <Link href="#faq" variant="standalone">FAQ</Link>
          ...
          <Grid columns={{ base: 1, md: 2 }} gap={8} align="start">
            <Flex gap={6}>
              <Flex row gap={3} align="center">
                ...
                <Text as="span" size="sm">35,000+ verified 5-star reviews*</Text>
              </Flex>
              <Heading level={1} display="lg">
                The foundation of daily health
              </Heading>
              <Text size="lg">
                Just one scoop covers your daily nutritional bases with
                ...
                <TabPanel value="one-time">
                  <Flex gap={4}>
                    <Flex row gap={3} align="baseline">
                      <Heading level={3} display="sm">$89</Heading>
                      <Text muted as="span">($2.97/serving)</Text>
                    </Flex>
                    <Text size="sm">30 servings, shipped once. No commitment.</Text>
                    <Button size="lg">Buy Now</Button>
                    <Text muted size="xs">90-day money-back guarantee. No commitment.</Text>
                  </Flex>
                </TabPanel>
                <TabPanel value="subscribe">
                  <Flex gap={4}>
                    <Flex row gap={3} align="baseline">
                      <Text as="span" muted style={{ textDecoration: 'line-through' }}>$89</Text>
                      <Heading level={3} display="sm">$79</Heading>
                      <Text muted as="span">($2.63/serving)</Text>
                    </Flex>
                    <Badge variant="success" size="sm">Save 10% for your first 3 months</Badge>
                    <Flex gap={2}>
                      <Text size="sm">30 servings, delivered monthly. Cancel or pause anytime.</Text>
          ...
          <Flex row gap={8} align="center" justify="center" wrap>
            {[
              ...
              <Flex key={badge.name} row gap={3} align="center">
                ...
                <Text size="xs" muted>{badge.name}</Text>
              </Flex>
            ))}
          </Flex>
        </Wrapper>
      ...
      <Section background="muted" padding="lg" id="benefits">
            ...
            {[
              {
                ...
                image: 'https://images.unsplash.com/photo-1490645935967-10de6ba17061?w=400&h=530&fit=crop',
                alt: 'Healthy bowl of whole foods',
              },
              {
                title: 'Energy',
                desc: 'Sustained energy without the crash',
                image: 'https://images.unsplash.com/photo-1502904550040-7534597429ae?w=400&h=530&fit=crop',
                alt: 'Person running at sunrise',
              },
              {
                title: 'Immunity',
                desc: 'Strengthen your body\u2019s natural defenses',
                image: 'https://images.unsplash.com/photo-1610832958506-aa56368176cf?w=400&h=530&fit=crop',
                alt: 'Citrus fruits rich in vitamin C',
              },
              {
                title: 'Recovery',
                desc: 'Reduce inflammation and support muscle repair',
                image: 'https://images.unsplash.com/photo-1544367567-0f2fcb009e0b?w=400&h=530&fit=crop',
                alt: 'Person stretching after exercise',
              },
              {
                title: 'Brain Health',
                desc: 'Support focus, clarity, and cognitive function',
                image: 'https://images.unsplash.com/photo-1559757175-5700dde675bc?w=400&h=530&fit=crop',
                alt: 'Person meditating in nature',
              },
              {
                title: 'Heart Health',
                desc: 'Support cardiovascular function and circulation',
                image: 'https://images.unsplash.com/photo-1498837167922-ddd27525d352?w=400&h=530&fit=crop',
        ...
        <Dialog open={nutritionOpen} onClose={() => setNutritionOpen(false)} aria-label="Nutrition facts">
          <Flex gap={6}>
            <Flex row align="center" justify="between">
              <Heading level={3}>Nutrition Facts</Heading>
              <Button variant="ghost" size="sm" iconOnly aria-label="Close" onClick={() => setNutritionOpen(false)}>
                ✕
              </Button>
            </Flex>
            <Text muted size="sm">Per serving (12g scoop). % Daily Value based on a 2,000 calorie diet.</Text>
            <Table>
              <TableHead>
                <TableRow>
            ...
            <Text muted size="xs">† Daily Value not established.</Text>
          </Flex>
        </Dialog>
      </Section>
          ...
          <Flex gap={10}>
            ...
            <Grid columns={{ base: 1, md: 3 }} gap={6}>
              <FeatureCard
                ...
                icon={<img className="examples-ecom-feature-image" src="https://images.unsplash.com/photo-1610970881699-44a5587cabec?w=600&h=400&fit=crop" alt="Assortment of vitamins and supplements" />}
              />
              <FeatureCard
                title="Third-Party Tested"
                description="Every batch is NSF Certified for Sport, ensuring the highest standards of quality and purity."
                icon={<img className="examples-ecom-feature-image" src="https://images.unsplash.com/photo-1650660149368-95e712f12ef0?w=600&h=400&fit=crop" alt="Laboratory testing equipment" />}
              />
              <FeatureCard
                ...
                icon={<img className="examples-ecom-feature-image" src="https://images.unsplash.com/flagged/photo-1557753478-b9fb74f39eb5?w=600&h=400&fit=crop" alt="Research and development laboratory" />}
              />
            </Grid>
          </Flex>
        </Wrapper>
        ...
        <Wrapper>
          <Flex gap={10}>
            <SectionHeader
              ...
              title="Approved by those who know best"
            />
              ...
              {[
                ...
                <Flex key={person.name} gap={3} align="center">
                  <Avatar
                    ...
                    size="lg"
                  />
                  <Text size="sm" weight="semibold" align="center">{person.name}</Text>
                  <Text size="xs" muted align="center">{person.role}</Text>
                </Flex>
              ))}
            </Grid>
          </Flex>
