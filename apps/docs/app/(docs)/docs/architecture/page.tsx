  ...
  "color": {
    ...
    "neutral": {
      ...
      "900": { "value": "#171717" }
          ...
          <Text>
            Semantic roles that reference raw values. &quot;Primary&quot; maps to neutral.900 by
            default, but a theme can remap it to any raw value.
          </Text>
          <CodeBlock
            code={`{
  "color": {
    ...
    "on-surface": {
      "default": { "value": "{color.neutral.900}" }
          ...
          <Text>
            Component-specific tokens that reference aliases. This is where the surface/on-surface
            convention maps to specific components.
          </Text>
          <CodeBlock
            code={`{
  "button": {
      ...
      "on-surface": {
        ...
        <Grid gap={4}>
          ...
          <Text>
            ...
            CSS lives in the tokens package as atom CSS that maps these hooks to token values.
          </Text>
          <CodeBlock
...
.tcn-button-primary {
  ...
  patterns/      → ${STAT_PATTERN_COUNT} theme-agnostic layout patterns`}
          ...
          />
          <Text>
            Build order: tokens → core → patterns. Turborepo manages the dependency graph. The
            documentation site and theme configurator live in separate repositories and consume the
