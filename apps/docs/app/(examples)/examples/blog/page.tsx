  ...
  return (
    <>
        ...
        <Wrapper size="xl">
          <Flex row align="center">
            ...
            <FlexItem shrink={false}>
              <Heading level={1} className="examples-masthead-logo">
                Factory Times
              </Heading>
            </FlexItem>
            <FlexItem grow>
                  ...
                  {mostRead.map((title, i) => (
                    <Flex key={title} gap={0}>
                      ...
                      <Flex row align="center" gap={4}>
                        <Text as="strong" className="examples-most-read-number">
                          {i + 1}
                        </Text>
        ...
        <Wrapper size="xl">
          <Grid columns={2} gap={8}>
            <Flex gap={3} justify="center">
              ...
              <Text>
                Listen to the stories that matter. Our daily podcast delivers the top headlines in
                under 20 minutes, and our weekly deep-dives explore the forces shaping global
                markets.
              </Text>
            </Flex>
            <Grid columns={2} gap={4}>
              ...
              <Box radius="md" padding="md">
                <Flex gap={2}>
                  ...
                  <Text size="sm">Every Friday. Deep analysis of the week in global finance.</Text>
                  <Flex row gap={2}>
                    <Link href="#" variant="standalone" size="sm">
                      Apple Podcasts
                    </Link>
              ...
              <Box radius="md" padding="md">
                <Flex gap={2}>
                  ...
                  <Text size="sm">Tuesdays. How technology is reshaping business and society.</Text>
                  <Flex row gap={2}>
                    <Link href="#" variant="standalone" size="sm">
                      Apple Podcasts
                    </Link>
              ...
              <Box radius="md" padding="md">
                <Flex gap={2}>
                  ...
                  <Text size="sm">Thursdays. The economics of the energy transition.</Text>
                  <Flex row gap={2}>
                    <Link href="#" variant="standalone" size="sm">
                      Apple Podcasts
                    </Link>
                ...
                <Box radius="md" padding="lg" elevation={1}>
                  <Flex gap={4}>
                    <Flex align="center" gap={2}>
                      <Avatar src={highlightedRead.avatar} alt={highlightedRead.author} size="lg" />
      ...
      <Footer
        ...
        logo={
          <Text as="strong" size="lg" className="examples-masthead-logo">
            Factory Times
          </Text>
        }
