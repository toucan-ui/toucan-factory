        ...
        rows={[
          {
            name: 'Alice',
            role: 'Engineer',
            status: { text: 'Engineer', badge: 'Active', badgeVariant: 'success' },
          },
          {
            name: 'Bob',
            role: 'Designer',
            status: { text: 'Designer', badge: 'Away', badgeVariant: 'warning' },
          },
        ]}
      />
    ),
    ...
    demo: (
      <ComparisonTable
        ...
        features={[
          ...
          {
            feature: 'Support',
            values: { Free: 'Community', Pro: 'Priority', Enterprise: 'Dedicated' },
          },
        ]}
...
/>`,
  ...
  'search-bar': {
    demo: <SearchBar placeholder="Search components..." buttonLabel="Search" />,
...
/>`,
  ...
  'loading-state': {
    demo: <LoadingState lines={3} showAvatar showHeading />,
