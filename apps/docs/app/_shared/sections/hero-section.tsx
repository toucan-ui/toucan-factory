          ...
          <GridItem>
            <Flex gap={8} align="start">
              <Text as="p" size="lg" muted>
                Patterns compose atoms, atoms reference tokens, themes override tokens. One source,
                infinite skins.
              </Text>
              <Text as="p" muted>
                Toucan is a design system that builds design systems. Swap a single JSON file and
                every component, every pattern, every layout re-skins itself — no code changes, no
                overrides, no hacks.
              </Text>
