    ...
    <Section gap={8} id="accessibility">
      ...
      <Wrapper size="xs">
        <Text as="p" muted>
          ...
          libraries, no accessibility plugins, no &quot;add ARIA later&quot;. Every component starts
          from the WAI-ARIA Authoring Practices and implements keyboard navigation, focus
          management, screen reader announcements, and semantic HTML as the first code written, not
          the last.
        </Text>
      </Wrapper>
