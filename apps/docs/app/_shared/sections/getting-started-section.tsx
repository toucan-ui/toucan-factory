    ...
    <Section id="getting-started">
      <Wrapper size="xs">
        <Grid gap={8}>
          ...
          <Grid gap={4}>
            <Text as="p" muted>
              <code>@toucan-ui/tokens/css</code> loads {STAT_TOKEN_COUNT} design tokens as CSS
              custom properties plus the atom CSS that maps them to component classes. Components
              from <code>@toucan-ui/core</code> emit semantic HTML with the right classes and{' '}
