  ...
  return (
    <Flex gap={6}>
      <Flex gap={2}>
        ...
        <Text variant="muted">
          Read-only reference showing how alias names map to raw scale steps. Spacing, sizing,
          radius, and border-width all share the same scale — adjusting the base unit on the Scale
          page cascades through every alias.
        </Text>
      </Flex>
      ...
      <AliasTable
        title="Border Width"
        aliases={BORDER_WIDTH_ALIASES}
        resolveValue={resolveBorderWidth}
      />
      <Separator />
      <OpacityTable />
    </Flex>
