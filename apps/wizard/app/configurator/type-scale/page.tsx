  ...
  return (
    <Flex gap={6}>
      <Flex gap={2}>
        ...
        <Text variant="muted">
          Raw tier — configure font families, the type size scale, weights, line heights, and letter
          spacings. These raw values are referenced by the Typography alias step to build semantic
          text styles.
        </Text>
      </Flex>
      <FontEditor />
