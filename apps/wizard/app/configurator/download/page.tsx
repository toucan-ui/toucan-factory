  ...
  return (
    <Flex gap={6}>
      <Flex gap={2}>
        ...
        <Text variant="muted">
          Export — review your theme in the preview panel, then download as CSS or JSON tokens. CSS
          output uses var() references to preserve the three-tier cascade. JSON output follows the
          DTCG format, organised into raw/, alias/, and system/ directories.
        </Text>
      </Flex>
