  ...
  return (
    <Flex gap={6}>
      <Flex gap={2}>
        ...
        <Text variant="muted">
          System tier — override tokens for individual components. Each component has system tokens
          (e.g. button padding, input radius) that default to alias values. Overriding a token here
          only affects that specific component, without changing the global alias.
        </Text>
      </Flex>
