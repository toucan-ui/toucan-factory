  ...
  return (
    <Flex gap={6}>
      <Flex gap={2}>
        ...
        <Text variant="muted">
          Raw tier — the foundation colour values everything else references. Create named colour
          scales by picking a base colour to auto-generate a full 50-950 shade range. Click any
          swatch to manually override individual shades.
        </Text>
      </Flex>
