  ...
  return (
    <Flex gap={6}>
      <Flex gap={2}>
        ...
        <Text variant="muted">
          Alias tier — map semantic colour roles to your raw palette shades. Components reference
          these aliases (e.g. &quot;primary&quot;, &quot;danger&quot;) rather than specific hex
          values, so changing a mapping here cascades through every component that uses it.
        </Text>
      </Flex>
      <RoleMapper />
    </Flex>
