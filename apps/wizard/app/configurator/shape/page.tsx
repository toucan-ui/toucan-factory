  ...
  return (
    <Flex gap={6}>
      <Flex gap={2}>
        ...
        <Text variant="muted">
          Border radii are controlled by the scale base unit — adjust it on the Scale page to
          proportionally resize all radii. Shadows define elevation levels for cards and overlays.
        </Text>
      </Flex>
      <RadiusEditor />
      <ShadowEditor />
