    ...
    <Flex gap={6}>
        ...
        <Flex row gap={2} align="end">
          <Flex gap={1}>
            <Text size="sm" weight="medium">
              Base Unit (px) - the cornerstone to all units of measurement, icons, border-radius,
              type.
            </Text>
            <Input
              type="number"
      ...
      <Flex gap={3}>
        ...
        <Flex row gap={2} align="end">
          <Flex gap={1}>
            <Text size="sm" weight="medium">
              Base Unit (px) - larger scale layotu orientated units. think Desktop wrapper padding
              or media query breakpoints, max-widths etc.
            </Text>
            <FlexItem shrink>
              <Input
                type="number"
