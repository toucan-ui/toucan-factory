...
export function generateCssProperties(state: ConfigState): Record<string, string> {
  ...
  // Raw scale tokens
  for (const [step, value] of Object.entries(scale.steps).sort(
  ...
  props['--text-display-sm-letter-spacing'] =
    `var(--font-letter-spacing-${a.displaySmLetterSpacing})`;
  ...
  props['--text-display-md-letter-spacing'] =
    `var(--font-letter-spacing-${a.displayMdLetterSpacing})`;
  ...
  props['--text-display-lg-letter-spacing'] =
    `var(--font-letter-spacing-${a.displayLgLetterSpacing})`;
  ...
  const allTokenDefs = [
    ...Object.values(SYSTEM_TOKENS).flat(),
    ...Object.values(SYSTEM_SURFACE_TOKENS).flat(),
  ];
...
export function generateCssFile(state: ConfigState): string {
  ...
  lines.push(
    `  --text-heading-h1-letter-spacing: var(--font-letter-spacing-${a.h1LetterSpacing});`,
  );
  ...
  lines.push(
    `  --text-heading-h2-letter-spacing: var(--font-letter-spacing-${a.h2LetterSpacing});`,
  );
  ...
  lines.push(
    `  --text-heading-h3-letter-spacing: var(--font-letter-spacing-${a.h3LetterSpacing});`,
  );
  ...
  lines.push(
    `  --text-heading-h4-letter-spacing: var(--font-letter-spacing-${a.h4LetterSpacing});`,
  );
  ...
  lines.push(
    `  --text-heading-h5-letter-spacing: var(--font-letter-spacing-${a.h5LetterSpacing});`,
  );
  ...
  lines.push(
    `  --text-heading-h6-letter-spacing: var(--font-letter-spacing-${a.h6LetterSpacing});`,
  );
  // Per-display tokens (sizes hardwired)
  ...
  lines.push(
    `  --text-display-sm-letter-spacing: var(--font-letter-spacing-${a.displaySmLetterSpacing});`,
  );
  ...
  lines.push(
    `  --text-display-md-letter-spacing: var(--font-letter-spacing-${a.displayMdLetterSpacing});`,
  );
  ...
  lines.push(
    `  --text-display-lg-letter-spacing: var(--font-letter-spacing-${a.displayLgLetterSpacing});`,
  );
  ...
  if (hasOverrides) {
    ...
    for (const [component, overrides] of Object.entries(componentOverrides)) {
      ...
      for (const [token, aliasValue] of Object.entries(overrides)) {
        const def =
          Object.values(SYSTEM_TOKENS)
            .flat()
            .find((d) => d.token === token) ??
          Object.values(SYSTEM_SURFACE_TOKENS)
            .flat()
            .find((d) => d.token === token);
        if (def) {
          const prefix = ALIAS_VAR_PREFIX[def.alias];
