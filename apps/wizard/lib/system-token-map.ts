...
export const SYSTEM_TOKENS: Record<string, SystemTokenDef[]> = {
  ...
  progress: [{ token: 'progress-radius', alias: 'radius', default: 'full' }],
};
...
export const SYSTEM_COLOUR_TOKENS: Record<string, SystemTokenDef[]> = {
  ...
  button: [
    ...
    {
      token: 'button-secondary-on-surface-default',
      alias: 'colour',
      default: 'on-surface-default',
    },
  ...
  focus: [{ token: 'focus-ring-color', alias: 'colour', default: 'border-focus' }],
  input: [
  ...
  select: [
    ...
    {
      token: 'select-trigger-on-surface-placeholder',
      alias: 'colour',
      default: 'on-surface-muted',
    },
  ...
  separator: [{ token: 'separator-color', alias: 'colour', default: 'border-default' }],
  skeleton: [{ token: 'skeleton-surface', alias: 'colour', default: 'surface-muted' }],
  textarea: [
  ...
  accordion: [
    ...
    {
      token: 'accordion-trigger-on-surface-default',
      alias: 'colour',
      default: 'on-surface-default',
    },
...
export const SYSTEM_SURFACE_TOKENS: Record<string, SystemTokenDef[]> = {
  ...
  box: [{ token: 'box-surface', alias: 'colour', default: 'surface-default' }],
  input: [
    { token: 'input-surface-default', alias: 'colour', default: 'surface-default' },
    { token: 'input-on-surface-default', alias: 'colour', default: 'on-surface-default' },
    { token: 'input-on-surface-placeholder', alias: 'colour', default: 'on-surface-muted' },
  ...
  checkbox: [{ token: 'checkbox-surface-default', alias: 'colour', default: 'surface-default' }],
  radio: [{ token: 'radio-surface-default', alias: 'colour', default: 'surface-default' }],
  toggle: [
    { token: 'toggle-track-surface-default', alias: 'colour', default: 'border-default' },
    { token: 'toggle-thumb-surface-default', alias: 'colour', default: 'surface-raised' },
  ],
  ...
  link: [{ token: 'link-color-default', alias: 'colour', default: 'primary' }],
  tabs: [
    { token: 'tabs-tab-surface-default', alias: 'colour', default: 'transparent' },
    { token: 'tabs-tab-on-surface-default', alias: 'colour', default: 'on-surface-muted' },
  ],
