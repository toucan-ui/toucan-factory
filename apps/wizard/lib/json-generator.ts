...
function generateRawScaleJson(state: ConfigState): object {
  ...
  for (const [step, value] of Object.entries(state.scale.steps).sort(
...
function generateAliasTypographyJson(state: ConfigState): object {
  ...
  return {
    body: {
      ...
      'letter-spacing': {
        $value: `{font.letter-spacing.${a.bodyLetterSpacing}}`,
        $type: 'dimension',
      },
    },
    mono: {
  ...
  return {
    text: {
      ...
      xs: {
        ...
        'letter-spacing': {
          $value: `{font.letter-spacing.${a.textXsLetterSpacing}}`,
          $type: 'dimension',
        },
      },
      sm: {
        ...
        'letter-spacing': {
          $value: `{font.letter-spacing.${a.textSmLetterSpacing}}`,
          $type: 'dimension',
        },
      },
      lg: {
        ...
        'letter-spacing': {
          $value: `{font.letter-spacing.${a.textLgLetterSpacing}}`,
          $type: 'dimension',
        },
      },
      heading: {
        ...
        h1: {
          ...
          'letter-spacing': {
            $value: `{font.letter-spacing.${a.h1LetterSpacing}}`,
            $type: 'dimension',
          },
        },
        h2: {
          ...
          'letter-spacing': {
            $value: `{font.letter-spacing.${a.h2LetterSpacing}}`,
            $type: 'dimension',
          },
        },
        h3: {
          ...
          'letter-spacing': {
            $value: `{font.letter-spacing.${a.h3LetterSpacing}}`,
            $type: 'dimension',
          },
        },
        h4: {
          ...
          'letter-spacing': {
            $value: `{font.letter-spacing.${a.h4LetterSpacing}}`,
            $type: 'dimension',
          },
        },
        h5: {
          ...
          'letter-spacing': {
            $value: `{font.letter-spacing.${a.h5LetterSpacing}}`,
            $type: 'dimension',
          },
        },
        h6: {
          ...
          'letter-spacing': {
            $value: `{font.letter-spacing.${a.h6LetterSpacing}}`,
            $type: 'dimension',
          },
        },
      },
      display: {
        ...
        sm: {
          ...
          'letter-spacing': {
            $value: `{font.letter-spacing.${a.displaySmLetterSpacing}}`,
            $type: 'dimension',
          },
        ...
        md: {
          ...
          'letter-spacing': {
            $value: `{font.letter-spacing.${a.displayMdLetterSpacing}}`,
            $type: 'dimension',
          },
        ...
        lg: {
          ...
          'letter-spacing': {
            $value: `{font.letter-spacing.${a.displayLgLetterSpacing}}`,
            $type: 'dimension',
          },
...
function generateSystemOverrideJson(component: string, overrides: Record<string, string>): object {
  const result: TokenGroup = {};

  for (const [token, aliasValue] of Object.entries(overrides)) {
    const def =
      SYSTEM_TOKENS[component]?.find((d) => d.token === token) ??
